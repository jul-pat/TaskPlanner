...
import { Button, Form, Input, Radio, Select, TextArea, Header, Segment, Message } from 'semantic-ui-react'
...
class AddTask extends React.Component {
  ...
  render() {
    const { name, description, type, category,  exp, gold, penalty, days, hours } = this.state
